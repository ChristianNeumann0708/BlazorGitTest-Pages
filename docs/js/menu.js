    ...
    <nav class="main-menu">
      ...
      <ul>
        ...
        <li><a href="import.html">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 3v12m0 0l-4-4m4 4l4-4m-9 5v4h10v-4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
          Import
        </a></li>
